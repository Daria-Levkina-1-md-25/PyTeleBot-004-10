...
# -----------------------------------------------------------------------
def dz7(bot, chat_id):
    proc_answer = lambda message: bot.send_message(chat_id, "Абсолютно точно верно, да, да, ты угадал!") if (message.text == "1") else bot.send_message(chat_id, "Нет")
